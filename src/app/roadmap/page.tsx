...
const sections = [
  { name: "2024", desc: "What's next", icon: "📅", anchor: "2024" },
  { name: "Vision", desc: "Long-term goals", icon: "🔭", anchor: "vision" },
];
  ...
  return (
    <main className="min-h-screen w-full bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 flex flex-col items-center">
      ...
      <section className="w-full flex flex-col items-center justify-center pt-24 pb-16 relative overflow-hidden">
        <h1 className="text-5xl md:text-6xl font-extrabold text-white text-center z-10 drop-shadow-lg mb-4">Roadmap</h1>
        <p className="text-xl md:text-2xl text-gray-200 text-center z-10 max-w-2xl mb-6">See what's next for PoPP and our long-term vision.</p>
      </section>
      {/* Sections */}
