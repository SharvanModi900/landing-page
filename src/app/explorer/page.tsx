...
import {
  ...
  Layers, ArrowRight, Hash, Zap, Eye, ChevronRight,
} from "lucide-react";
        ...
        <section className="max-w-5xl mx-auto px-6 mb-6">
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              { label: "Total On-Chain", value: totalTickets, icon: <Shield className="h-4 w-4 text-emerald-400" />, gradient: "from-emerald-500/10 to-teal-600/10", border: "border-emerald-500/20" },
            ].map((stat, i) => (
              <motion.div
                key={stat.label}
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-xl p-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex-1 flex items-center bg-white/5 border border-white/10 rounded-lg px-3 py-2.5 gap-2">
                ...
                <input
                  type="text"
                  placeholder="Search by description, ID, category, region..."
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-sm text-gray-400">
                {searchQ || categoryFilter !== "All" ? "Try adjusting your search or filters." : "No problems have been submitted yet."}
              </p>
            </div>
          ) : (
