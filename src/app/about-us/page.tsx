          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center">
              <a href="https://github.com/SharvanModi900/proof-of-problem-protocol" target="_blank" rel="noopener noreferrer"
                className="flex flex-col items-center gap-3 p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-colors group max-w-sm">
                <Github className="w-8 h-8 text-gray-400 group-hover:text-blue-400 transition" />
                <h4 className="text-lg font-semibold text-white">Proof of Problem Protocol</h4>
                <p className="text-sm text-gray-400">Protocol research, whitepaper, chapters, architecture blueprints, web interfaces, and documentation.</p>
