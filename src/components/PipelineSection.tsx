    ...
    <section id="pipeline" className="relative py-24 px-6">
      ...
      <div className="max-w-4xl mx-auto text-center mb-20">
        <h2 className="text-4xl lg:text-5xl font-extrabold text-white mb-4 tracking-tight">
          The <span className="bg-gradient-to-r from-cyan-400 via-purple-400 to-amber-400 bg-clip-text text-transparent">Protocol Pipeline</span>
        </h2>
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <div className="absolute left-8 lg:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-red-500/40 via-purple-500/40 via-green-500/40 to-amber-500/40" />

        {/* Animated particle on the line */}
        <motion.div
          className="absolute left-[30px] lg:left-1/2 w-2 h-2 -translate-x-1/2 rounded-full bg-cyan-400 shadow-[0_0_8px_#22d3ee]"
          animate={{ top: ["0%", "100%", "0%"] }}
            ...
            >
              ...
              <div className="absolute left-8 lg:left-1/2 -translate-x-1/2 z-10">
                <div
                  ...
                  style={{ boxShadow: `0 0 20px ${stage.color}33` }}
                >
                  {stage.icon}
                </div>
              </div>
